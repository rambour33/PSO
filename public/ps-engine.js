// ── Shared particle engine — makePS, THEME_PARTICLES, CHAR_TO_THEME
// Inclus dans vs-screen.html et victory.html

// ── Particle engine factory ─────────────────────────────────
function makePS(canvasEl) {
  const _ps = (() => {
  ...
  function resize() {
    canvas.width  = canvas.offsetWidth  || 960;
...
// ── Character ID → theme key ────────────────────────────────
const CHAR_TO_THEME = {
  mario:'smario', donkey_kong:'sdk', link:'slink', samus:'ssamus',
  dark_samus:'sdsamus', yoshi:'syoshi', kirby:'skirby', fox:'sfox',
  pikachu:'spikachu', luigi:'sluigi', ness:'sness',
  captain_falcon:'sfalcon', jigglypuff:'sjigglypuff',
  peach:'speach', daisy:'sdaisy', bowser:'sbowser',
  ice_climbers:'siceclimbers', sheik:'ssheik', zelda:'szelda',
  dr_mario:'sdrmario', pichu:'spichu', falco:'sfalco',
  marth:'smarth', lucina:'slucina', young_link:'sylink',
  ganondorf:'sganondorf', mewtwo:'smewtwo', roy:'sroy',
  chrom:'schrom', mr_game_watch:'sgamewatch', meta_knight:'smetaknight',
  pit:'spit', dark_pit:'sdarkpit', zero_suit_samus:'szss',
  wario:'swario', snake:'ssnake', ike:'sike',
  pokemon_trainer:'spktrainer', diddy_kong:'sdiddy', lucas:'slucas',
  sonic:'ssonic', king_dedede:'sdedede', olimar:'solimar',
  lucario:'slucario', rob:'srob', toon_link:'stoonlink',
  wolf:'swolf', villager:'svilager', mega_man:'smegaman',
  wii_fit_trainer:'swiifit', rosalina:'srosalina',
  little_mac:'slittlemac', greninja:'sgreninja',
  mii_brawler:'smii_brawl', mii_swordfighter:'smii_sword',
  mii_gunner:'smii_gun', palutena:'spalutena', pac_man:'spacman',
  robin:'srobin', shulk:'sshulk', bowser_jr:'sbowserjr',
  duck_hunt:'sduckhunt', ryu:'sryu', ken:'sken', cloud:'scloud',
  corrin:'scorrin', bayonetta:'sbayonetta', inkling:'sinkling',
  ridley:'sridley', simon:'ssimon', richter:'srichter',
  king_k_rool:'skrool', isabelle:'sisabelle', incineroar:'sincineroar',
  piranha_plant:'spiranha', joker:'sjoker', hero:'shero',
  banjo_kazooie:'sbanjo', terry:'sterry', byleth:'sbyleth',
  min_min:'sminmin', steve:'ssteve', sephiroth:'ssephiroth',
