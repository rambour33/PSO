// Shared particle engine factory â used by overlay.html and twitch-chat.html
window.createParticleSystem = function(canvasId, containerId) {
...
window.THEME_PARTICLES = {
  ...
  flag_es:  { type:'sparkle', count:60 },
  flag_it:  { type:'sparkle', count:60 },
  flag_de:  { type:'sparkle', count:55 },
  flag_nl:  { type:'sparkle', count:60 },
  flag_pt:  { type:'sparkle', count:55 },
  flag_at:  { type:'sparkle', count:55 },
  flag_ca:  { type:'sparkle', count:60 },
  flag_us:  { type:'sparkle', count:65 },
  flag_mx:  { type:'sparkle', count:60 },
